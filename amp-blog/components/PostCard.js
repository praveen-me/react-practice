...
const Postcard = ({ title, excerpt, featuredImage, tags }) => {
	return (
		<div className='post-card max-w-sm rounded overflow-hidden shadow-lg my-4 mx-4'>
			...
			<div className='px-6 py-4'>
				{tags.nodes.map((node) => (
					<span className='inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 m-3'>
